...
static const struct r36sx_key_choice g_choices[] = {
    ...
    { "CAPS", R36SX_SCREEN_KEY_CAPITAL },
    { "INSERT", R36SX_SCREEN_KEY_INSERT },
    { "HOME", R36SX_SCREEN_KEY_HOME },
    { "PGUP", R36SX_SCREEN_KEY_PRIOR },
    { "END", R36SX_SCREEN_KEY_END },
    { "PGDN", R36SX_SCREEN_KEY_NEXT },
    { "PRINT", R36SX_SCREEN_KEY_PRINT },
    { "SCROLL", R36SX_SCREEN_KEY_SCROLL },
    { "PAUSE", R36SX_SCREEN_KEY_PAUSE },
