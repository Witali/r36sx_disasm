...
#define R36SX_SCREEN_KEYBOARD_PANEL_H 80
...
enum {
    ...
    R36SX_SCREEN_KEY_RWIN = 92,
    R36SX_SCREEN_KEY_APPS = 93,
    R36SX_SCREEN_KEY_NUMPAD0 = 96,
    R36SX_SCREEN_KEY_NUMPAD1 = 97,
    R36SX_SCREEN_KEY_NUMPAD2 = 98,
    R36SX_SCREEN_KEY_NUMPAD3 = 99,
    R36SX_SCREEN_KEY_NUMPAD4 = 100,
    R36SX_SCREEN_KEY_NUMPAD5 = 101,
    R36SX_SCREEN_KEY_NUMPAD6 = 102,
    R36SX_SCREEN_KEY_NUMPAD7 = 103,
    R36SX_SCREEN_KEY_NUMPAD8 = 104,
    R36SX_SCREEN_KEY_NUMPAD9 = 105,
    R36SX_SCREEN_KEY_MULTIPLY = 106,
    R36SX_SCREEN_KEY_ADD = 107,
    R36SX_SCREEN_KEY_SEPARATOR = 108,
    R36SX_SCREEN_KEY_SUBTRACT = 109,
    R36SX_SCREEN_KEY_DECIMAL = 110,
    R36SX_SCREEN_KEY_DIVIDE = 111,
    R36SX_SCREEN_KEY_F1 = 112,
    R36SX_SCREEN_KEY_NUMLOCK = 144,
    R36SX_SCREEN_KEY_SCROLL = 145,
    R36SX_SCREEN_KEY_LSHIFT = 160,
    R36SX_SCREEN_KEY_RSHIFT = 161,
    R36SX_SCREEN_KEY_LCONTROL = 162,
    R36SX_SCREEN_KEY_RCONTROL = 163,
    R36SX_SCREEN_KEY_LMENU = 164,
    R36SX_SCREEN_KEY_RMENU = 165,
